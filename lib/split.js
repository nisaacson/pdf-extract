 ...
 * @return {Array} output paths an array of the absolute paths to the single
    ...
    fs.mkdir(output_dir, function(err) {
      ...
      var child = exec(cmd, function (err, stdout, stderr) {
        if (err) {
          ...
          cleanup_directory(output_dir, function (cleanup_err, reply) {
            if (cleanup_err) {
              output_err.err = output_err.err+', cleanup error: ' + cleanup_err;
            }
